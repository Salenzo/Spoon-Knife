...
cmake -DCMAKE_SYSTEM_VERSION=10.0.22621.0 -DCMAKE_IGNORE_PATH=C:\ProgramData\chocolatey\bin;C:\Strawberry\c\bin\c++ ^
  -DCMAKE_BUILD_TYPE=RelWithDebInfo -DLAF_BACKEND=skia ^
